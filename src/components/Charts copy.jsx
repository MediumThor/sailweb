  ...
  return (
    <div className="h-full w-full relative overflow-hidden">
        ...
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 bg-zinc-800 bg-opacity-80 text-white rounded-2xl px-14 py-4 shadow-xl z-[1000] text-center space-y-3">
          ...
          {timeToCurrentDestination != null && (
            <div className="text-2xl font-medium text-zinc-300">
              ETA to next waypoint: {timeToCurrentDestination} min
            </div>
          )}
        </div>
      )}
      ...
      {destinations.length > 0 && isValidCoord(lat) && isValidCoord(lon) && (
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-zinc-800 bg-opacity-80 text-white rounded-full px-8 py-4 text-xl font-semibold shadow-xl z-[1000] text-center space-y-1">
